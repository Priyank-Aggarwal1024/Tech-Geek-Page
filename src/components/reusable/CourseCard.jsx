...
function CourseCard({ item, add }) {
    return (
        <div className="alac-pack-new-course-card-div">
            <div className="alac-pack-new-ccd-left">
                <div className="alac-pack-new-ccdl-left"><img src={item.img} alt={item.text} /></div>
                <div className="alac-pack-new-ccdl-right">{item.text}</div>
            </div>
            <div className="alac-pack-new-ccd-right">
                <div className="alac-pack-new-ccdr-left">
                    ...
                    <span className="alac-pack-new-view">view</span>
                </div>
                {add && <div className="alac-pack-new-ccdr-right">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="33" viewBox="0 0 32 33" fill="none">
                    ...
                    <span className="alac-pack-new-add">Add</span>
                </div>}
            </div>
        </div>
    );
