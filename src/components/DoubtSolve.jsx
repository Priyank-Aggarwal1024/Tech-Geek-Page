...
function DoubtSolve() {
    return (
        <>
            <section className="section alac-pack-new-doubt-solve">
                <h2 className="alac-pack-new-doubt-solve-heading fw-400 text-pink">
                    Instant{" "}<span className="fw-700">Doubt Solving</span>
                </h2>
                <div className="alac-pack-new-doubt-main">
                    <div className="alac-pack-new-doubt-left">
                        <svg className='alac-pack-new-doubt-design' xmlns="http://www.w3.org/2000/svg" width="526" height="249" viewBox="0 0 526 249" fill="none">
                            <g opacity="0.4">
                        ...
                        <div className="alac-pack-new-doubt-card alac-pack-new-doubt-card1">
                            <div className="alac-pack-new-dc-left">
                                <img src={Chat} alt="Chat Doubt Image" />
                            </div>
                            <div className="alac-pack-new-dc-right">
                                <p className="alac-pack-new-dc-heading">Doubts Solved in 5-10 min</p>
                                <p className="alac-pack-new-dc-text">
                                    Ask your doubts when you want, and get it solved within 5-10 minutes
                                </p>
                            </div>
                        </div>
                        <div className="alac-pack-new-doubt-card alac-pack-new-doubt-card2">
                            <div className="alac-pack-new-dc-left">
                                <img src={Read} alt="Read Doubt Image" />
                            </div>
                            <div className="alac-pack-new-dc-right">
                                <p className="alac-pack-new-dc-heading">Experience 1 to 1 learning</p>
                                <p className="alac-pack-new-dc-text">
                    ...
                    <div className="alac-pack-new-doubt-right">
